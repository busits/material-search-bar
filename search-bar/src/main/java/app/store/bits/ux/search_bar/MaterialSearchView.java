package app.store.bits.ux.search_bar;
...
import app.store.bits.ux.search_bar.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public void setVoiceIcon(@DrawableRes int resId) {
        mVoiceBtn.setImageResource(resId);
    }
    ...
    public void setCloseIcon(@DrawableRes int resId) {
        mEmptyBtn.setImageResource(resId);
    }
